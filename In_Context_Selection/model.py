...
class policy_network(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.tokenizer = AutoTokenizer.from_pretrained(model_config,cache_dir = '/NS/ssdecl/work')
        print("model_config:", model_config)
        self.model = AutoModelForTokenClassification.from_pretrained(model_config,cache_dir = '/NS/ssdecl/work')
