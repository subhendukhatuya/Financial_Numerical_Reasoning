...
tacos_dataset_train = TourismDataset(csv_file='./finqa_train_rel_fact_instruction_2.csv',
                                     root_dir='./')

tacos_dataset_test = TestDataset(csv_file='./finqa_test_rel_fact_instruction_2.csv', root_dir='./')
...
output_dir="lora-flan-t5-large-finqa-rel-fact"
...
# train model
trainer.train()
peft_model_id="lora_flan_large_model_finqa_rel_fact"
...
correct = 0
total = 0
f1 = open('./lora_flan_large_prediction_finqa_rel_fact.txt', 'w')
